...
func Boy_Talk(s *Script) {
	...
	s.The("quip", Called("OldBoy: Later"),
		...
		Has("comment", `"Oh, sorry," Alice says. "I'll be back."[goodbye quietly]`))

	s.The("quip requirements",
		Table("fact", "permits-property", "quip").
			Contains("boy-cam", "prohibits", "OldBoy: Later").
			And("boy-cam", "permits", "OldBoy: CameraTime"))
	...
	s.The("quip", Called("OldBoy: Camera"),
		...
		After("reporting discuss").Always(func(g G.Play) {
			QuipMemory.Learn(g.The("boy-cam"))
		}))
	...
	s.The("quip", Called("OldBoy: CameraTime"),
		...
		Has("reply", `[beat] "I feel like there"s some context I"m missing here..."[goodbye]`))

	s.The("quip",
		Called("OldBoy: DoesAnybody"),
		Has("subject", "Alien Boy"),
		DirectlyFollows("OldBoy: WhatsTheMatter"),
		Is("super important"),
		//Has("hook",  `A matter disrupter?`)
		Has("comment", `"[The hook]"asks Alice"), "Does anybody?"`),
		Has("reply", `"Or,"asks the Alien Boy, "maybe a ray gun?"`))

	s.The("quip",
		Called("OldBoy: Forcing"),
		Has("subject", "Alien Boy"),
		IndirectlyFollows("OldBoy: WhatsTheMatter"),
		IndirectlyFollows("OldBoy: HelloAgain"),
	...
	*/
	...
	s.The("quip requirements",
		Table("fact", "permits-property", "quip").
			Contains("aliens-take-alot-of-photos", "permits", "OldBoy: Photos"))
	...
	s.The("quip",
		...
		Has("reply", `[beat]"Was it something I said?"[goodbye quietly]`))
}
